...
def occitanie_montpellier_educonnect(
    ...
    return cas_edu(
        "https://cas.mon-ent-occitanie.fr/login?selection=MONT-EDU_parent_eleve",
        username,
        password,
    )


def ent_auvergnerhonealpe(
    username: str, password: str
) -> requests.cookies.RequestsCookieJar:
    """
    ...
    return cas_edu(
        "https://cas.ent.auvergnerhonealpes.fr/login?selection=EDU", username, password
    )


def ac_orleans_tours(
    username: str, password: str
) -> requests.cookies.RequestsCookieJar:
    """
    ...
    return cas_edu(
        "https://ent.netocentre.fr/cas/login?&idpId=parentEleveEN-IdP",
        username,
        password,
    )


def monbureaunumerique(
    username: str, password: str
) -> requests.cookies.RequestsCookieJar:
    """
    ...
    return cas_edu(
        "https://cas.monbureaunumerique.fr/login?selection=EDU", username, password
    )
