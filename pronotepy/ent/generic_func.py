...
def _educonnect(session: requests.Session, username: str, password: str, url: str) -> requests.Response:
    """
...
def _cas_edu(username: str, password: str, url: str = '') -> requests.cookies.RequestsCookieJar:
    """
...
def _cas(username: str, password: str, url: str = '') -> requests.cookies.RequestsCookieJar:
    """
...
def _open_ent_ng_edu(username: str, password: str, domain: str = '') -> requests.cookies.RequestsCookieJar:
    """
...
def _open_ent_ng(username: str, password: str, url: str = '') -> requests.cookies.RequestsCookieJar:
    """
...
def _simple_auth(username: str, password: str, url: str = '', form_attr: dict = {}) -> requests.cookies.RequestsCookieJar:
    """
